 ...
 */
public class Transaksi_PurcaseOrder extends javax.swing.JFrame {
koneksi kon = new koneksi();
private Object[][] datasementara=null;
private String[]labelsementara={"Kode Barang","Nama Barang","Qty","Status"};
    /**
     * Creates new form Transaksi_BarangMasuk
     */
    public Transaksi_PurcaseOrder() {
        initComponents();
        kon.setKoneksi();
        setTanggal();
        awal();
    ...
    public String nomor(){
        String urutan=null;
            try{
                kon.rs=kon.st.executeQuery("select right(id_pesan,3)+1 "
                        + "from pemesanan as Nomor order by id_pesan desc");
                if(kon.rs.next())
                {
    ...
    private void TampilTabelSementara(){
        try{
            String sql="Select * from sementara2 order by id_produk";
            ...
            while(kon.rs.next()){
                ...
                datasementara[x][2]=kon.rs.getString("qty");
                datasementara[x][3]=kon.rs.getString("status");
                x++;
            }
    ...
    private void SimpanSementara(){
        try{
            String sql="insert into sementara2 value('" +tkdproduk.getText()+"',"
                    +"'"+tnmproduk.getText()+"','"+tqty.getText()+"','"+tpesan.getText()+"')";
    ...
    private void HapusIsiSementara(){
        ...
        try{
            String sql="Delete from sementara2 where id_produk='"+(String)tbl_brgmasuk.getValueAt(row, 0)+"'";
            kon.st.executeUpdate(sql);
            TampilTabelSementara();
        }
        catch(SQLException e){
    ...
    private void SimpanTransaksi(){
        try{
            String sql="insert into pemesanan values('"+tnomasuk.getText()+"',"
                    + "'"+ttanggal.getText()+"',"
                    + "'"+tsup.getText()+"',"
                    + "'"+tkduser.getText()+"')";
            kon.st.executeUpdate(sql);
    ...
    private void simpanDetailTransaksi(){
        try{
            String detail ="insert detail_pemesanan select '"+tnomasuk.getText()+"',"
                    + "id_produk, qty, status from sementara2";
    ...
    private void HapusTabelSementara(){
        try{
            String sql="Delete from sementara2";
            kon.st.executeUpdate(sql);
            TampilTabelSementara();
        }
        catch(SQLException e){
    ...
    private void initComponents() {
        ...
        jLabel2.setText("No. Barang Masuk");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(tnomasuk, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(70, 70, 70)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(tnomasuk, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel3)
        ...
        tbl_brgmasuk.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Barang", "Nama Barang", "Qty", "Status"
            }
        ));
        ...
        tpesan.setFont(new java.awt.Font("Tahoma", 3, 18)); // NOI18N
        tpesan.setText("Sedang Dipesan");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addComponent(tpesan, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btambahActionPerformed
        // TODO add your handling code here:
        tnomasuk.setText(nomor());
    }//GEN-LAST:event_btambahActionPerformed

    private void bcariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bcariActionPerformed
        // TODO add your handling code here:
        Data_Produk dp= new Data_Produk(this, rootPaneCheckingEnabled);
        dp.po = this;
        dp.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Transaksi_PurcaseOrder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Transaksi_PurcaseOrder().setVisible(true);
            }
        });
    }
