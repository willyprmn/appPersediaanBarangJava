 ...
 */
public class Transaksi_BarangKeluar extends javax.swing.JFrame {
...
private String[]labelsementara={"Kode Barang","Nama Barang","Qty"};
    ...
    public String nomor(){
        String urutan=null;
            try{
                kon.rs=kon.st.executeQuery("select right(id_brgkeluar,3)+1 "
                        + "from barang_keluar as Nomor order by id_brgkeluar desc");
                if(kon.rs.next())
                {
                    urutan=kon.rs.getString(1);
                    while(urutan.length()<3)
                        urutan="0"+urutan;
                    urutan="BK-"+noformat.format(date)+urutan;
                }else
                {
                    urutan="BK-"+noformat.format(date)+"001";
                }
            }
            catch(Exception e){
    ...
    private void SimpanTransaksi(){
        try{
            String sql="insert into barang_keluar values('"+tnokeluar.getText()+"',"
                    + "'"+ttanggal.getText()+"',"
                    + "'"+tkduser.getText()+"')";
            kon.st.executeUpdate(sql);
        }
    ...
    private void simpanDetailTransaksi(){
        try{
            String detail ="insert detail_keluar select '"+tnokeluar.getText()+"',"
    ...
    private void initComponents() {
        ...
        setTitle("Transaksi Keluar Barang");
        ...
        jLabel2.setText("No. Barang Keluar");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(tnokeluar, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(95, 95, 95)
    ...
    private void btambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btambahActionPerformed
        // TODO add your handling code here:
        tnokeluar.setText(nomor());
    }//GEN-LAST:event_btambahActionPerformed

    private void bcariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bcariActionPerformed
        // TODO add your handling code here:
        Data_ProdukJual dk= new Data_ProdukJual(this, rootPaneCheckingEnabled);
        dk.bk = this;
        dk.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Transaksi_BarangKeluar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Transaksi_BarangKeluar().setVisible(true);
            }
        });
    }
