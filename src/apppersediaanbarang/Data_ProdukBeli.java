 ...
 */
public class Data_ProdukBeli extends javax.swing.JDialog {
koneksi kon = new koneksi();
    public Transaksi_BarangMasuk bm = null;
    private Object [][] datapro = null;
    private String [] label={"ID PO","ID Produk","Nama Produk","Stok"};
    /**
     * Creates new form Data_Produk
     */
    public Data_ProdukBeli(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        kon.setKoneksi();
        BacaTabelProduk();
    ...
    private void BacaTabelProduk(){
        try{
            String sql="SELECT * from detail_pemesanan join produk on detail_pemesanan.id_produk=produk.id_produk WHERE STATUS='Sedang Dipesan'";
            ...
            while(kon.rs.next()){
                ...
                datapro[x][3]=kon.rs.getString("qty");
                x++;
            }
    ...
    {
        try{
            String sql="SELECT * from detail_pemesanan join produk on detail_pemesanan.id_produk=produk.id_produk WHERE id_pesan like '%" +tcari.getText()+ "%' ";
            kon.rs=kon.st.executeQuery(sql);
            ResultSetMetaData m=kon.rs.getMetaData();
            int kolom=m.getColumnCount();
            int baris=0;
    ...
    {
        try{
            String sql="SELECT * from detail_pemesanan join produk on detail_pemesanan.id_produk=produk.id_produk WHERE nama_produk like '%" +tcari.getText()+ "%' ";
            kon.rs=kon.st.executeQuery(sql);
            ResultSetMetaData m=kon.rs.getMetaData();
            int kolom=m.getColumnCount();
            int baris=0;
    ...
    private void initComponents() {
        ...
        tbl_produk.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID PO", "ID Produk", "Nama Produk", "Stok"
            }
        ));
    ...
    private void tbl_produkMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_produkMouseClicked
        ...
        bm.KodePO = tbl_produk.getValueAt(tabelProduk, 0).toString();
        bm.KodeProduk = tbl_produk.getValueAt(tabelProduk, 1).toString();
        bm.NamaProduk = tbl_produk.getValueAt(tabelProduk, 2).toString();
        bm.Stok = tbl_produk.getValueAt(tabelProduk, 3).toString();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Data_ProdukBeli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Data_ProdukBeli dialog = new Data_ProdukBeli(new javax.swing.JFrame(), true);
