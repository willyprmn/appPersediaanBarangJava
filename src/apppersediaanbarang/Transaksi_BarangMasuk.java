 ...
 */
public class Transaksi_BarangMasuk extends javax.swing.JFrame {
...
private String[]labelsementara={"Kode Barang","Nama Barang","Qty"};
    ...
    public String nomor(){
        String urutan=null;
            try{
                kon.rs=kon.st.executeQuery("select right(id_brgmasuk,3)+1 "
                        + "from barang_masuk as Nomor order by id_brgmasuk desc");
                if(kon.rs.next())
                {
                    urutan=kon.rs.getString(1);
                    while(urutan.length()<3)
                        urutan="0"+urutan;
                    urutan="BM-"+noformat.format(date)+urutan;
                }else
                {
                    urutan="BM-"+noformat.format(date)+"001";
                }
            }
            catch(Exception e){
    ...
    private void TampilTabelSementara(){
        try{
            ...
            while(kon.rs.next()){
                ...
                datasementara[x][2]=kon.rs.getString("stok");
                x++;
            }
    ...
    private void SimpanSementara(){
        try{
            String sql="insert into sementara value('" +tkdproduk.getText()+"',"
    ...
    private void HapusIsiSementara(){
        ...
        try{
            String sql="Delete from sementara where id_produk='"+(String)tbl_brgmasuk.getValueAt(row, 0)+"'";
            kon.st.executeUpdate(sql);
            TampilTabelSementara();
        }
        catch(SQLException e){
    ...
    private void SimpanTransaksi(){
        try{
            String sql="insert into barang_masuk values('"+tnomasuk.getText()+"',"
                    + "'"+ttanggal.getText()+"',"
                    + "'"+tkduser.getText()+"')";
            kon.st.executeUpdate(sql);
        }
    ...
    private void simpanDetailTransaksi(){
        try{
            String detail ="insert detail_masuk select '"+tnomasuk.getText()+"',"
                    + "id_produk, stok from sementara";
    ...
    {
        try{
            String sql="update detail_pemesanan set status='Barang Tiba' where id_pesan='"+tpo.getText()+"'";
            kon.st.executeUpdate(sql);
        }
        catch(SQLException e)
        {
    ...
    private void initComponents() {
        ...
        tpo = new javax.swing.JTextField();
        jLabel1 = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Transaksi Masuk Barang");
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel8)
                    .addComponent(tpo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
    ...
    private void bcariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bcariActionPerformed
        // TODO add your handling code here:
        Data_ProdukBeli dp= new Data_ProdukBeli(this, rootPaneCheckingEnabled);
        dp.bm = this;
        dp.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Transaksi_BarangMasuk().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField tpo;
